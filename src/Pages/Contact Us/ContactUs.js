...
const ContactUs = () => {
    return (
        <div>
            ...
            <div className="cotanct-bottom-banner text-white">
            ...
            <div className="py-12 md:py-16 lg:py-24 container full-width-all m-auto">
                ...
                <div className="grid grid-cols-12 gap-8 px-2 ">
                    ...
                    <div className='col-span-12 md:col-span-8 bg-indigo-200 rounded-xl shadow-2xl'>
                        <div className=" p-8 m-auto">
                            ...
                            <form >
                                ...
                                <div className="text-center pt-4">
                                    <button className="rounded-full py-2 px-4 border text-indigo-900 text-lg font-semibold border-indigo-900 hover:bg-indigo-900 hover:text-white transition duration-500 ease-in-out " >Send Message</button>
                                </div>
                            </form>
                        </div>
                    </div>
