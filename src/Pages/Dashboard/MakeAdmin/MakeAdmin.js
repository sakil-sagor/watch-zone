...
const MakeAdmin = () => {
    ...
    return (
        <div>
            ...
            <div>
                <h1 className="text-indigo-900 font-semibold text-4xl mb-6 ml-4">Admin Role</h1>
            </div>
            <hr />
            ...
            <div className="ml-4 my-8">
                <form onSubmit={handelMakeAdmin}>
                    ...
                    <br />
                    <input onBlur={handelField} className="bg-gray-300 text-xl py-2 px-4 rounded-lg my-4 w-3/4" type="email" name="email" id="email" />
                    <br />
                    <input value="Make Admin" type="submit" className="bg-indigo-800 hover:bg-indigo-900 py-2 px-4 text-white rounded-lg" />

                </form>
            </div>
            <div className="mt-12">
                <h1 className="text-indigo-900 font-semibold text-xl mb-6 ml-4 ">Admin List</h1>
                <hr />
