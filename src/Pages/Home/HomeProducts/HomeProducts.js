    ...
    <div className="py-24 our-doctors-container">
      <div className="container m-auto full-width-all ">
        ...
        <div>
          {products.length ? (
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-6 px-2 ">
              {products.slice(numStart, numStart + 8).map((product) => (
        ...
        <div className="mt-16 text-center ">
          <NavLink
            className="rounded-full py-3 px-6 border text-indigo-900 text-lg font-semibold border-indigo-900 hover:bg-indigo-900 hover:text-white transition duration-500 ease-in-out "
            to="/shop"
          >
            {" "}
            Find more Products
